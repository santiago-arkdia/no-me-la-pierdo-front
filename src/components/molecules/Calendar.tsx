...
const Calendar: React.FC<CalendarProps> = ({
  ...
  const isToday = (date: number) => {
    ...
    return (
      today.getDate() === date &&
      today.getMonth() === datepickerHeaderDate.getMonth() &&
      today.getFullYear() === datepickerHeaderDate.getFullYear()
    );
  };
  ...
  const isSelectedDay = (date: number) => {
    return (
      ...
      selectedDay.getMonth() === datepickerHeaderDate.getMonth() &&
      selectedDay.getFullYear() === datepickerHeaderDate.getFullYear()
    );
  };
