          ...
          {session?.user ? (
            <>
              <div>
                <button
                  onClick={() => signOut()}
                  className="py-2 px-3 mr-5 rounded-md tracking-wide  transition duration-300 bg-blue text-black"
                >
                  Cerrar sesión
                </button>
              </div>
            ...
            <>
              <div>
                <button
                  onClick={openModal}
                  className="py-2 px-3 mr-5 rounded-md tracking-wide border-2 border-blue transition duration-300 hover:bg-blue hover:text-black"
                >
                  Iniciar sesión
                </button>
